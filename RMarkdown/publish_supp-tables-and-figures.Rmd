...
load("../RData/publish_figsS1-S4.RData")
```
...
ggarrange(shrub.change.precip, herb.change.precip,
          ...
          labels = c("(A)", "(B)"))
```
**Figure S3.** Simple linear regression of (A) change in native shrub cover and (B) change in native herbaceous cover as a function of the previous year’s precipitation, pooling all sampling locations and times.
