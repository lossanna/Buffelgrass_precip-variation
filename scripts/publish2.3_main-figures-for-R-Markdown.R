...
# Purpose: Create RData for R Markdown document (save insight datagrids prior to filtering
#   as separate objects).
...
insight.total.shrub.precip.uf <- insight.total.shrub.precip
...
insight.total.herb.precip.uf <- insight.total.herb.precip
...
insight.total.shrub.slope.uf <- insight.total.shrub.slope
...
insight.repro.shrub.slope.uf <- insight.repro.shrub.slope
...
insight.repro.bgden.precip.uf <- insight.repro.bgden.precip
...
insight.bgden.shrub.precip.uf <- insight.bgden.shrub.precip
...
save.image("RData/publish2.3_main-figures-for-R-Markdown.RData")
