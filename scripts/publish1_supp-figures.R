...
# Figure S1
tiff("figures/publish1-figures/FigureS1_600dpi.tiff",
     units = "in", height = 4, width = 6, res = 600)
repro.shrub.precip
dev.off()

# Figure S2
tiff("figures/publish1-figures/FigureS2_600dpi.tiff",
     units = "in", height = 4, width = 6, res = 600)
repro.herb.precip
dev.off()

# Figure S3
tiff("figures/publish1-figures/FigureS3_600dpi.tiff",
...
# Figure S4
tiff("figures/publish1-figures/FigureS4_600dpi.tiff",
     units = "in", height = 4, width = 5, res = 600)
repro.aspect
dev.off()

# Figure S5
tiff("figures/publish1-figures/FigureS5_600dpi.tiff",
     units = "in", height = 4, width = 5, res = 600)
bgden.aspect
dev.off()

# Figure S4
tiff("figures/publish1-figures/FigureS6_600dpi.tiff",
     units = "in", height = 4, width = 5, res = 600)
bgcov.aspect
dev.off()

# Figure S7
tiff("figures/publish1-figures/FigureS7_600dpi.tiff",
     units = "in", height = 4, width = 6, res = 600)
bgcov.shrub.precip
dev.off()

# Figure S8
tiff("figures/publish1-figures/FigureS8_600dpi.tiff",
     units = "in", height = 4, width = 5, res = 600)
density.cover
dev.off()

# Figure S9
tiff("figures/publish1-figures/FigureS9_600dpi.tiff",
     units = "in", height = 4, width = 5, res = 600)
total.cover
dev.off()
...
save(repro.shrub.precip, repro.herb.precip, shrub.change.precip, herb.change.precip,
     ...
     file = "RData/publish1_figsS1-S9.RData")

save.image("RData/publish1_supp-figures.RData")
